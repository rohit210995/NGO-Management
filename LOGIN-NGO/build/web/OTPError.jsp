...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <p style="text-align:center; color:red; font-size:2em;margin-top:250px;">
       ...
       <strong>Please try <a href="Confirmation.jsp">AGAIN</a><br><br></strong>
       <strong>If you keep on getting this error message, kindly contact the admin @ : 210995rohit@gmail.com</strong>
    </p>
</body>
</html>
