  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">WELCOME, ${Username}
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img style="height:650px;" src="Images/imagesforeachwebpage/registration.jpg" alt="New York" width="1200" height="700">
      ...
      <div class="item">
        <img style="height:650px;" src="Images/imagesforeachwebpage/index3.png" alt="Chicago" width="1200" height="700">
        <!-- <div class="carousel-caption">
          <h3>Chicago</h3>
      ...
      <div class="item">
        <img style="height:650px;" src="Images/ngo/26.jpg" alt="Los Angeles" width="1200" height="700">
        <!-- <div class="carousel-caption">
          <h3>LA</h3>
...
<div id="tour" class="bg-1">
  ...
  <p class="text-center">Click <a href="event.html">Here</a> to View More Events !!!</p><br>
  <!-- Modal -->
